...
=======
      ...
      <section className="relative min-h-[100svh] bg-[#0F0C07] flex flex-col items-center justify-center pt-24 pb-20 px-6 overflow-hidden z-10">
        ...
        >
          ...
          >
            Beautiful digital invitations, token-based RSVP tracking, real-time headcount dashboards, and caterer kitchen reports &mdash; all built for the grandeur of Indian weddings.
          </motion.p>
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              >
                <div className="text-gold font-display text-7xl absolute top-4 left-6 opacity-20 leading-none select-none drop-shadow-sm">&ldquo;</div>
                <p className="font-display text-xl text-ink italic leading-relaxed mb-10 relative z-10 pt-6">&ldquo;{t.quote}&rdquo;</p>
