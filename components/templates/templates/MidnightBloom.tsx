      ...
      <div className="flex flex-col h-full w-full relative z-10 px-6 pt-12 pb-10">
         ...
         <div className="w-full mb-6 relative">
            ...
            >
              ...
              >&amp;</motion.span> {(data.coupleNames.split(' & ')[1] || data.coupleNames.split(' AND ')[1] || '').split(' ')[0]}
            </motion.h1>
         ...
         {/* Buttons */}
          ...
          {isPreview && (
            <div className="flex gap-2 w-full mb-8 z-20">
               <motion.button whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} className="flex-1 bg-[#D1B162] text-[#EBE5D9] font-body font-bold text-[10px] uppercase py-3 shadow-[2px_2px_0px_#3B2C1A] border border-[#3B2C1A]">RSVP</motion.button>
               <motion.button whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} className="flex-1 bg-[#93281E] text-[#EBE5D9] font-body font-bold text-[10px] uppercase py-3 shadow-[2px_2px_0px_#3B2C1A] border border-[#3B2C1A]">SCHEDULE</motion.button>
            </div>
          )}
