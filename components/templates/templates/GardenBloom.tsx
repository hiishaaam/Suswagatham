  ...
  return (
    <div className="w-full min-h-[100dvh] bg-gradient-to-b from-[#31224A] to-[#1A0A2E] relative overflow-hidden font-body text-white flex flex-col items-center justify-between">
      ...
      <div className="relative w-full h-[300px] flex justify-center items-center isolate mt-auto mb-auto">
         ...
         >
            <img src={data.photoUrl || "https://images.unsplash.com/photo-1544928147-79a2dbc1f389?auto=format&fit=crop&q=80"} className="w-full h-full object-cover" alt="Background" />
         </motion.div>
         ...
         <motion.div 
            ...
            className="absolute w-[160px] h-[220px] rounded-[16px] overflow-hidden rotate-6 translate-x-14 opacity-60 mix-blend-luminosity shadow-2xl pointer-events-none"
         >
            <img src={data.photoUrl || "https://images.unsplash.com/photo-1511285560929-80b456fea0bc?auto=format&fit=crop&q=80"} className="w-full h-full object-cover" alt="Background" />
         </motion.div>
         ...
         >
            <img src={data.photoUrl || "https://images.unsplash.com/photo-1583939003579-730e3918a45a?auto=format&fit=crop&q=80"} className="w-full h-[120%] object-cover object-top" alt="Couple" />
