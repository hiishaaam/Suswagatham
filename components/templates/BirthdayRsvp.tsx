// Auto-generated Template: BirthdayRsvp
...
<div className="bg-surface-container-low rounded-xl p-8 space-y-6 shadow-[0_-10px_40px_-10px_rgba(56,57,42,0.06)] relative overflow-hidden">
<div className="absolute top-0 right-0 p-4 opacity-10">
<span className="material-symbols-outlined text-6xl" style={{"fontVariationSettings":"'FILL' 1"}}>pets</span>
</div>
<h2 className="text-xl font-bold text-on-surface">How many party animals are coming?</h2>
<div className="flex items-center justify-between bg-surface-container-highest rounded-full p-2">
<button className="w-16 h-16 rounded-full bg-primary text-on-primary flex items-center justify-center hover:opacity-90 active:scale-95 transition-all shadow-lg">
<span className="material-symbols-outlined text-3xl">remove</span>
</button>
<span className="text-5xl font-black text-on-surface px-6">02</span>
<button className="w-16 h-16 rounded-full bg-secondary text-on-primary flex items-center justify-center hover:opacity-90 active:scale-95 transition-all shadow-lg">
...
<div className="flex items-center gap-3">
<span className="material-symbols-outlined text-tertiary" style={{"fontVariationSettings":"'FILL' 1"}}>restaurant</span>
<h2 className="text-xl font-bold text-on-surface">Yummy Food Choices</h2>
</div>
<div className="grid grid-cols-2 gap-4">

<button className="flex flex-col items-center gap-3 p-6 bg-secondary-container rounded-lg border-4 border-secondary transition-all transform hover:scale-105">
<div className="text-4xl">🥦</div>
<span className="font-bold text-on-secondary-container">Veggie Power</span>
...
<button className="flex flex-col items-center gap-3 p-6 bg-surface-container-highest rounded-lg border-4 border-transparent opacity-60 hover:opacity-100 transition-all transform hover:scale-105">
<div className="text-4xl">🍗</div>
<span className="font-bold text-on-surface-variant">Meat Treat</span>
...
<label className="block text-sm font-bold text-on-surface-variant ml-2">Any allergies or special secrets?</label>
<div className="bg-surface-container-highest rounded-lg p-4">
<textarea className="w-full bg-transparent border-none focus:ring-0 placeholder:text-outline-variant text-on-surface font-medium" placeholder="Type here..." rows={2}></textarea>
</div>
</div>

<button className="w-full py-5 rounded-xl bg-gradient-to-r from-primary to-primary-container text-on-primary text-xl font-extrabold shadow-xl hover:opacity-90 active:scale-95 transition-all mb-12 flex items-center justify-center gap-3">
                Confirm Headcount!
...
<nav className="fixed bottom-0 left-0 w-full flex justify-around items-center px-4 pb-6 pt-4 bg-[#ffffd3]/80 backdrop-blur-xl dark:bg-yellow-950/80 z-50 rounded-t-[3rem] shadow-[0_-10px_40px_-10px_rgba(56,57,42,0.06)]">
<a className="flex flex-col items-center justify-center text-[#38392a] dark:text-yellow-100 opacity-60 hover:bg-[#2e7238]/10 rounded-full transition-all px-4 py-2" href="#">
<span className="material-symbols-outlined">celebration</span>
<span className="font-plus-jakarta-sans text-xs font-bold">Party</span>
</a>
<a className="flex flex-col items-center justify-center text-[#38392a] dark:text-yellow-100 opacity-60 hover:bg-[#2e7238]/10 rounded-full transition-all px-4 py-2" href="#">
<span className="material-symbols-outlined">location_on</span>
<span className="font-plus-jakarta-sans text-xs font-bold">Map</span>
</a>
<a className="flex flex-col items-center justify-center bg-[#2e7238] text-white rounded-full px-6 py-2 shadow-lg animate-spring bounce-effect" href="#">
<span className="material-symbols-outlined" style={{"fontVariationSettings":"'FILL' 1"}}>check_circle</span>
<span className="font-plus-jakarta-sans text-xs font-bold">RSVP</span>
</a>
</nav>
